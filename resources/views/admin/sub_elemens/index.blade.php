            ...
            <form action="{{ route('admin.kriterias.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <label class="form-label fw-semibold small">Kode Sub-sub <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" step="0.01" min="0" max="100" name="nilai_maksimal" class="form-control" value="4.00" required>
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-semibold small">Deskripsi Pertanyaan Sub-sub Elemen <span class="text-danger">*</span></label>
                            <textarea name="deskripsi" class="form-control" rows="3" placeholder="Tuliskan uraian pertanyaan kriteria penilaian..." required></textarea>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.kriterias.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-light border small mb-3">
                            <strong>Induk Sub-Elemen:</strong> Sub {{ $sub->kode_sub }} - {{ $sub->nama_sub }} (Elemen {{ $sub->elemen ? $sub->elemen->kode_elemen : '-' }})
                        </div>
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label fw-semibold small">Kode Sub-sub Elemen <span class="text-danger">*</span></label>
                                <input type="text" name="kode_kriteria" class="form-control font-monospace" placeholder="Contoh: {{ $sub->kode_sub }}.1" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold small">Nilai Maksimal <span class="text-danger">*</span></label>
                                <input type="number" step="0.01" min="0" max="100" name="nilai_maksimal" class="form-control" value="4.00" required>
                            ...
                            <div class="col-12">
                                <label class="form-label fw-semibold small">Deskripsi Pertanyaan Sub-sub Elemen <span class="text-danger">*</span></label>
                                <textarea name="deskripsi" class="form-control" rows="3" placeholder="Uraian kriteria penilaian audit..." required></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer border-top">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content card-custom border-0">
                    <form action="{{ route('admin.kriterias.update', $kriteria->id) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="modal-header border-bottom">
                            <h5 class="modal-title fw-bold">Edit Sub-sub Elemen <span class="badge bg-dark font-monospace">{{ $kriteria->kode_kriteria }}</span></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <select name="sub_elemen_id" class="form-select" required>
                                        @foreach($subElemens as $s)
                                            <option value="{{ $s->id }}" {{ $kriteria->sub_elemen_id == $s->id ? 'selected' : '' }}>
                                                Sub {{ $s->kode_sub }} - {{ $s->nama_sub }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <label class="form-label fw-semibold small">Nilai Maksimal <span class="text-danger">*</span></label>
                                    <input type="number" step="0.01" min="0" max="100" name="nilai_maksimal" class="form-control" value="{{ $kriteria->nilai_maksimal }}" required>
                                </div>
                                <div class="col-12">
                                    <label class="form-label fw-semibold small">Deskripsi Pertanyaan <span class="text-danger">*</span></label>
                                    <textarea name="deskripsi" class="form-control" rows="3" required>{{ $kriteria->deskripsi }}</textarea>
                                </div>
                                <div class="col-12">
